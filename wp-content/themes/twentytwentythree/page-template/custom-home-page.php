...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod( 'vw_education_academy_slider_hide_show', false) != '' || get_theme_mod( 'vw_education_academy_resp_slider_hide_show', false) != '') { ?>
          ...
          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            ...
            <div class="carousel-caption">
              <div class="inner_carousel">
                ...
                <p class="wow slideInLeft delay-1000" data-wow-duration="2s"><?php $excerpt = get_the_excerpt(); echo esc_html( vw_education_academy_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_education_academy_slider_excerpt_number','30')))); ?></p>
